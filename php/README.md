* **eedclientinfo.php** : Classe qui permet de connaitre le type d'application utilsé par l'eedomus (portail, portail mobile, box local, application android, application android)
```
